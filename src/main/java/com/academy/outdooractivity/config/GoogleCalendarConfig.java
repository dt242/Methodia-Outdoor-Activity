...
public class GoogleCalendarConfig {
    ...
    private static final String APPLICATION_NAME = "Outdoor Activity Planner";
    ...
    public Calendar googleCalendar() throws Exception {
        ...
        try (InputStream in = GoogleCalendarConfig.class.getResourceAsStream(CREDENTIALS_FILE_PATH)) {
            if (in == null) {
